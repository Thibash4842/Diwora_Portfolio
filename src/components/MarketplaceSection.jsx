...
const MarketplaceSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Header Area */}
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 w-full flex flex-col gap-3 mb-8 md:mb-12 pt-4 md:pt-0 relative z-10">
      ...
      <div className="sticky top-[80px] h-[calc(140vh-80px)] md:h-[150vh] lg:h-[calc(100vh-80px)] w-full flex items-center overflow-hidden z-10">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 w-full h-full relative flex items-center">
